...
Usage
-----
    academic-agent                          # interactive menu
    academic-agent structure research       # paper structure
    academic-agent section introduction     # section guide
    academic-agent abstract                 # abstract template
    academic-agent literature               # literature review tips
    academic-agent question                 # research question guide
    academic-agent cite --style apa         # citation builder (interactive)
    academic-agent analyse "<text>"         # writing analysis
    academic-agent help                     # show all commands
"""
